...
def render_modulo_usabilidad():
    ...
    # RESTAURADOS LOS 21 DATOS ORIGINALES
    data = {
    ...
    # --- IMÁGENES PARA EL PDF (MATPLOTLIB) ---
    ...
    with st.sidebar:
        ...
        st.download_button(label="📥 Descargar Reporte PDF", data=pdf_bytes, file_name="Reporte.pdf", mime="application/pdf", use_container_width=True)

    st.info(f"**Análisis Estratégico:** El puntaje de **{promedio_sus:.1f}** indica usabilidad alta.")
